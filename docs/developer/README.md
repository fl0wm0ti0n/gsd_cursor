...
- **BUG-0012** — `/auto` full_autonomy stops after each story despite native chain (US-0095 regression); traceability: `/auto`, see `docs/engineering/architecture.md`.
- **BUG-0013** — Scratchpad example stale: template example missing features written to canonical scratchpad; traceability: `/scratchpad`, see `docs/engineering/architecture.md`.
...
- **US-0103** — AI Decision Ledger + Plan Fidelity policy; traceability: `/auto`, see `docs/engineering/architecture.md`.
- **US-0108** — Parallel Instance Arbitrage for dev phase; traceability: `/execute`, see `docs/engineering/architecture.md`.
- **US-0111** — Release-trigger-driven version changelog derivation; traceability: `/release`, see `docs/engineering/architecture.md`.
- **US-0112** — Ship model-catalog example presets on install/upgrade; traceability: `/upgrade`, see `docs/engineering/architecture.md`.
...
- **US-0097** — Project-owned root README bootstrap + per-story/sprint growth (framework README in `its_magic/` only); traceability: `/sprint`, see `docs/engineering/architecture.md`.
- **US-0098** — Dev environment auto-launch profile (detect, persist, relaunch, connect); traceability: `/execute`, see `docs/engineering/architecture.md`.
- **US-0102** — Direct per-phase model slug override and role-based catalog presets (US-0101 extension); traceability: `/balanced`, see `docs/engineering/architecture.md`.
- **US-0104** — Cross-Model Adversarial Critic; traceability: `/sovereign-critic`, see `docs/engineering/architecture.md`.
- **US-0105** — Sovereign Memory; traceability: `/refresh-context`, see `docs/engineering/architecture.md`.
- **US-0106** — Sovereign Role-Behavior Manifest; traceability: `SOVEREIGN_ROLE_MANIFEST`, see `docs/engineering/architecture.md`.
- **US-0107** — Sovereign Loop Mode (AUTO_SOVEREIGN); traceability: `AUTO_SOVEREIGN`, see `docs/engineering/architecture.md`.
- **US-0110** — Goal-Based Convergence Loops; traceability: `SOVEREIGN_GOAL_MODE`, see `docs/engineering/architecture.md`.
...
- **US-0094** — README visionary intro + tiered feature hierarchy (root/template parity); traceability: `/template`, see `docs/engineering/architecture.md`.
- **US-0095** — Native in-Cursor `/auto` auto-chaining (no outer driver required); traceability: `/auto`, see `docs/engineering/architecture.md`.
- **US-0096** — Delivery modes: ultra-lean + mega-quick token lifecycle with layered memory; traceability: `/pack`, see `docs/engineering/architecture.md`.
- **US-0099** — Auto-bootstrap dev-environment profile on install/upgrade (non-destructive); traceability: `/upgrade`, see `docs/engineering/architecture.md`.
- **US-0100** — Version-scoped release changelog and GitHub release-note attachment; traceability: `/releases`, see `docs/engineering/architecture.md`.
- **US-0101** — Per-phase model tier selection for subagents (MODEL_TIER + local catalog); traceability: `/agents`, see `docs/engineering/architecture.md`.
- **US-0109** — Self-Healing Deploy Loop (post-deploy smoke probe + bounded repair); traceability: `/release`, see `docs/engineering/architecture.md`.
