...
## Current context pack (2026-04-05 — **`BUG-0008` DONE**; sprint **`S0070` released** (**`auto-20260404-03`**); curator **`/refresh-context`** **`2026-04-05T23:45:00Z`**; **`R-0069`** delivery closed; prior **`US-0084` DONE** / **`S0069` released** (**`auto-20260404-02`**); normative **`DEC-0070`**; canonical **bug** rows **`BUG-0001`..`BUG-0008`** all **DONE**; next work **`US-0087`** **OPEN** — **`/discovery`** or **`/auto start-from=discovery`**; optional **`/intake`** for other **US** tracks)
...
- Hot surface: latest **`/refresh-context` (2026-04-05T23:45:00Z)** post-**`S0070`** / **`BUG-0008`** on **`auto-20260404-03`** (decisions/sprint summary/resume alignment; **`R-0069`** closed; next **`US-0087`** **`discovery`**). Prior: post-**`S0069`** / **`US-0084`** (**`auto-20260404-02`**); post-**`S0068`** / **`BUG-0007`** (**`auto-20260404-01`**); post-**`S0067`** / **`BUG-0006`** (**`auto-20260403-03`**); post-**`S0066`** / **`BUG-0005`** (**`auto-20260403-02`**); post-**`S0065`** / **`BUG-0004`** (**`auto-20260403-01`**).
