...
## Current context pack (2026-04-18 — **`US-0090`** **OPEN** / **ARCHITECTURE PASS** — `auto-20260418-01`, `fresh_context_marker=tl-US0090-architecture-20260418T220000Z-fresh`, `runtime_proof_id=rp-auto-20260418-01-architecture-tech-lead-20260418T220000Z-US0090`; binding **`DEC-0073`** composes on **`DEC-0072`** (forward-link, no rewrite); architecture section **`docs/engineering/architecture.md`** **`# US-0090`** appended; research anchor **`R-0073`** (shared with US-0089); eight deferred questions resolved (Q9/Q10/Q11/Q12/Q15/Q16/Q17/Q19); four risks resolved (R8 aggressive deferred / R9 3-family vocabulary gate / R10 no rule-subsection in v1 / R11 install-completeness fixture non-negotiable); AC-1..AC-8 mapped to DEC-0073 §§2/3/4/5/6/7/8/9/10; next phase **`/sprint-plan`** (fresh tech-lead); US-0089 DONE / **`S0075` released** (**`2026-04-18T19:00:00Z`**); portfolio **bugs** **`BUG-0001`..`BUG-0008`** **DONE** (no OPEN bugs); **`AUTO_BACKLOG_DRAIN`** budget remaining **5** of **10**)
...
- Continuation hygiene: **`handoffs/resume_brief.md`** routes to **`/intake`** (no **OPEN** story in **`docs/product/backlog.md`**) after curator **`/refresh-context`** on **`auto-20260405-01`** (**`S0074`** / **`US-0086`**) — canonical **bug** portfolio **`BUG-0001`..`BUG-0008`** **DONE** (**no OPEN** bugs); **`AUTO_BACKLOG_DRAIN`** budget remaining **6** of **10**.
...
- Hot surface: latest **`/refresh-context` (2026-04-13T23:00:00Z)** post-**`S0074`** / **`US-0086`** on **`auto-20260405-01`** (decisions/sprint summary/resume/research alignment; **`R-0068`** closed; next phase **`/intake`** with no OPEN story). Prior: post-**`S0073`** / **`US-0085`** (**`2026-04-13T18:00:00Z`**); post-**`S0072`** / **`US-0088`** (**`2026-04-13T01:30:00Z`**); post-**`S0071`** / **`US-0087`** (**`2026-04-12T20:35:00Z`**); post-**`S0070`** / **`BUG-0008`** (**`2026-04-05T23:45:00Z`**, **`auto-20260404-03`**).
...
- Index pattern: `decisions/DEC-0003.md` ... `decisions/DEC-0072.md`.
