...
## Current context pack (2026-04-19 — **`US-0090`** **DONE** / **`S0076` released** — `auto-20260418-01`, `fresh_context_marker=curator-S0076-US0090-refresh-context-20260419T003000Z-fresh`, `runtime_proof_id=rp-auto-20260418-01-refresh-context-curator-20260419T003000Z-S0076-US0090`; binding **`DEC-0073`** composes on **`DEC-0072`** (forward-link, no rewrite); **`S0076`** released **`2026-04-19T00:05:00Z`** (commit **`f0276d4`** + US-0089/S0075 reconciliation pushed `cfb37cf..f0276d4  main -> main`); AC-1..AC-8 `[x]`; `.cursor/rules/caveman.mdc` SHA-256 **`E10EFC32…E47DE`** preserved end-to-end (active == template); two carried-forward non-blocking notes recorded in release findings — (1) `PARTIAL_VERBATIM` on DEC-0073 §1 publication (reference + runbook paraphrase; architecture verbatim; DEC-0072 §6 row 6 pinned test preserved byte-unchanged), (2) UAT-3 `--dry-run` vs `--write` narration variance (AC-4 fail-closed intent satisfied via `--write` evidence); 9 pre-existing canonical harness failures remain (US-0086/US-0087/US-0088/Homebrew families) unchanged; research anchor **`R-0073`** now **delivered** for both US-0089 and US-0090 scopes; next phase **drain terminated** (`no_open_stories` — every `## US-xxxx` and `## BUG-xxxx` section in `docs/product/backlog.md` reports `Status: DONE`); **`AUTO_BACKLOG_DRAIN`** budget remaining **4** of **10** (unused); `/auto` next invocation routes to **`/intake`** (no OPEN story/bug) per precedent of prior drained states.
...
- Continuation hygiene: **`handoffs/resume_brief.md`** routes to **`/intake`** (no **OPEN** story in **`docs/product/backlog.md`**; every `## US-xxxx` and `## BUG-xxxx` section reports `Status: DONE`) after curator **`/refresh-context`** on **`auto-20260418-01`** (**`S0076`** / **`US-0090`**) — canonical **bug** portfolio **`BUG-0001`..`BUG-0008`** **DONE** (**no OPEN** bugs); **`AUTO_BACKLOG_DRAIN`** budget remaining **4** of **10** (unused; drain terminated `no_open_stories`).
...
- Hot surface: latest **`/refresh-context` (2026-04-19T00:30:00Z)** post-**`S0076`** / **`US-0090`** on **`auto-20260418-01`** (decisions/sprint summary/resume/research/state alignment; **`R-0073`** delivery closed for both US-0089 + US-0090; drain terminated `no_open_stories`; next phase routes to **`/intake`** on next `/auto` invocation). Prior: post-**`S0075`** / **`US-0089`** (**`2026-04-18T20:00:00Z`**, **`auto-20260418-01`**); post-**`S0074`** / **`US-0086`** (**`2026-04-13T23:00:00Z`**, **`auto-20260405-01`**); post-**`S0073`** / **`US-0085`** (**`2026-04-13T18:00:00Z`**); post-**`S0072`** / **`US-0088`** (**`2026-04-13T01:30:00Z`**); post-**`S0071`** / **`US-0087`** (**`2026-04-12T20:35:00Z`**).
...
- Index pattern: `decisions/DEC-0003.md` ... `decisions/DEC-0073.md`.
