...
## Current context pack (2026-04-05 — **`BUG-0007` DONE**; sprint **`S0068` released**; curator **`/refresh-context`** completed on **`auto-20260404-01`**; **`R-0066`** delivery closed; canonical **bug** rows **`BUG-0001`..`BUG-0007`** all **DONE** (**no OPEN** in range per **`docs/product/backlog.md`**); next work **`/intake`** (next **US**) or idle until scheduled; prior **`BUG-0006` / `S0067`** (**`auto-20260403-03`**), **`BUG-0005` / `S0066`** (**`auto-20260403-02`**), **`BUG-0004` / `S0065`** (**`auto-20260403-01`**) remain released)
...
- Continuation hygiene: **`handoffs/resume_brief.md`** routes to **`/intake`** (next **US**) after **`S0068`** / **`BUG-0007`** refresh closure on **`auto-20260404-01`** — canonical **bug** portfolio **`BUG-0001`..`BUG-0007`** **DONE** (**no OPEN** in range); prior released evidence unchanged for **`S0067`** / earlier sprints.
...
- Hot surface: latest **`/refresh-context` (2026-04-05)** post-**`S0068`** / **`BUG-0007`** on **`auto-20260404-01`** (decisions/research/sprint summary/resume alignment; **`R-0066`** closed). Prior: post-**`S0067`** / **`BUG-0006`** (**`auto-20260403-03`**); post-**`S0066`** / **`BUG-0005`** (**`auto-20260403-02`**); post-**`S0065`** / **`BUG-0004`** (**`auto-20260403-01`**).
...
- Index pattern: `decisions/DEC-0003.md` ... `decisions/DEC-0069.md`.
