...
- First archived heading: `# US-0106 — Sovereign Role-Behavior Manifest (per-role objectives + cross-role review obligations)`
- Last archived heading: `# BUG-0013 — Scratchpad example stale (template example missing 9 sections written to canonical)`
- Verification tuple (mandatory):
  - archived_body_lines=645
  - preamble_lines=1
  - retained_body_lines=2964
