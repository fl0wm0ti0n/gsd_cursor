...
- note=prepended newest sovereign-critic execute unit above execute producer checkpoint
- post_append_check=python scripts/enforce-triad-hot-surface.py --check (run after this append)
