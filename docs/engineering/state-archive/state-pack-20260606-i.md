...
- **Triad hot-surface (DEC-0054)**: post-append triad gate per checkpoint body below.
...
| `evidence_ref` | `[docs/product/backlog.md, docs/product/vision.md, docs/engineering/research.md, handoffs/po_to_tl.md, handoffs/resume_brief.md, docs/engineering/state.md (this checkpoint)]` |
...
- Post-append: `python scripts/enforce-triad-hot-surface.py --rollover` then `--check` — see rollover tuple appended after gate run.
- **Verification tuple**: (filled after rollover execution in this phase).
