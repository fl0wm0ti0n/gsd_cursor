...
- First archived heading: `## Sovereign-critic checkpoint â€” US-0123 / S0123 / auto-20260824-01 (producer: dev / execute harness-refresh)`
- Last archived heading: `## Sovereign-critic checkpoint â€” US-0123 / S0123 / auto-20260824-01 (producer: dev / execute harness-refresh)`
...
## Sovereign-critic checkpoint â€” US-0123 / S0123 / auto-20260824-01 (producer: dev / execute harness-refresh)

- `orchestrator_run_id=auto-20260824-01`
- `phase_id=sovereign-critic`
- `role=tech-lead`
- `producer_phase=execute` (harness-refresh â€” gate-1 for /release)
- `producer_role=dev`
